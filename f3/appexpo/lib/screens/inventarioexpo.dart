...
import 'package:flutter/material.dart' show AppBar, Axis, BuildContext, Builder, Column, Container, CrossAxisAlignment, EdgeInsets, ElevatedButton, Expanded, Image, InkWell, InputDecoration, InteractiveViewer, Key, ListTile, ListView, MaterialPageRoute, MediaQuery, Navigator, Row, Scaffold, SingleChildScrollView, SizedBox, State, StatefulWidget, StatelessWidget, Text, TextEditingController, TextField, TextInputType, Widget;
...
class inventarioExpo extends StatefulWidget {
  inventarioExpo({super.key}) {
    // TODO: implement inventarioExpo
