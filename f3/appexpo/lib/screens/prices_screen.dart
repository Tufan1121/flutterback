  ...
  Widget build(BuildContext context) {
   ...
   Widget buildProductDetails() {
    return Column(
      ...
      children: <Widget>[
        Text(_nombreProducto, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
    ...
    return Column(
      children: [
        ...
        ListView.separated(
          ...
          separatorBuilder: (context, index) => const Divider(), // Agrega una línea divisoria
        ),
      ],
    );
  } else {
