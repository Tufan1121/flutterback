...
class InventarioBodegasScreen extends StatefulWidget {
  @override
  _InventarioBodegasScreenState createState() => _InventarioBodegasScreenState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Text('Precio Normal: ${formatCurrency.format(item['precio1'])}, Precio Expo: ${formatCurrency.format(item['precio2'])}, Precio Mayoreo: ${formatCurrency.format(item['precio3'])}'),
        ],
      ),
    );
  }
}
class _InventarioBodegasScreenState extends State<InventarioBodegasScreen> {
  ...
  Future<void> _buscarInventario() async {
    ...
    String baseUrl = 'https://tapetestufan.mx:6002/ibodegas/';
...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(
      title: Text('Inventario En Bodegas'),
    ),
      ...
      child: Column(
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: 'Color/Diseño'),
          ),
          Row(
            children: <Widget>[
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Medidas Largo Desde'),
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                ),
              ),
              SizedBox(width: 10), // Espacio entre los dos campos de texto
              Expanded(
                child: TextField(
                  controller: _medidasLargoHastaController,
                  decoration: InputDecoration(labelText: 'Medidas Largo Hasta'),
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                ),
              ),
            ],
            ...
            children: <Widget>[
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Medidas Ancho Desde'),
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                ),
              ),
              SizedBox(width: 10), // Espacio entre los dos campos de texto
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Medidas Ancho Hasta'),
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                ),
              ),
            ],
          ...
          ElevatedButton(
            ...
            child: Text('Buscar en Bodegas'),
          ),
          Container(
            height: MediaQuery.of(context).size.height * 0.5,
            child: _searchResults.isNotEmpty ? _buildSearchResultsList() : Text(''),
          ),
        ],
      ),
    ),
          ...
          children: <Widget>[
            Container(
              ...
              child: InteractiveViewer(
                child: Image.network('https://tapetestufan.mx:446/imagen/' + item['pathima1']), // Muestra la imagen en miniatura
                minScale: 0.1,
                maxScale: 2.0,
              ),
            ),
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('Precio Normal: ${formatCurrency.format(item['precio1'])}, Precio Expo: ${formatCurrency.format(item['precio2'])}, Precio Mayoreo: ${formatCurrency.format(item['precio3'])}'), // Muestra los precios
                  ],
                ),
              ),
            ),
