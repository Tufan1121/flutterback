...
class inventarioExpo extends StatefulWidget {
  @override
  _inventarioExpoState createState() => _inventarioExpoState();
}
...
class _inventarioExpoState extends State<inventarioExpo> {
  ...
  Future<void> _buscarInventario() async {
    ...
    String baseUrl = 'https://tapetestufan.mx:6002/busquedaExpo/';
